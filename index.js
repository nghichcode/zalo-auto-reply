  ...
  const result = await completeWithPreparedSimpleCompletionModel({
    ...
    context: {
      systemPrompt: [
        ...
        "So sánh tin nhắn với CẢ Q (câu hỏi) VÀ A (nội dung câu trả lời) để tìm mục phù hợp nhất — người dùng có thể hỏi về thông tin nằm trong A chứ không nhất thiết trùng Q.",
        "Nếu tìm được mục phù hợp: trả về faqIndex và tổng hợp answer dựa trên nội dung A của mục đó (chỉ dùng thông tin trong A, không bịa thêm).",
